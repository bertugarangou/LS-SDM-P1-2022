...
MODE_ACTUAL EQU 0X0A
 ...
 ; b1[1:s'està reproduint NO-RECORD-NO SI-PLAY-SI; 0: no reproduint, normal]
...
T_TROBAT
    ...
    CAGARRO
    MOVLW .100; COMPARADOR AMB HISTÈRESIS
    CPFSLT TMP2,0
    BCF MODE_ACTUAL,0,0
...
PLAY_RAM_SONG
	...
	LOOP_TEMPS
	    ...
	    MOVFF NOTA_RAM, EUSART_INPUT;PER APROFITAT LA FUNCIO QUE JA TENIM ENGANYEM D'ON ENS VE LA NOTA
